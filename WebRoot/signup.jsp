...
<html>
 ...
 <body>
    ...
    <div id="js-show-modal" class="launch-button">登录
    ...
    <div id="js-modal-holder" class="modal-holder">
      <div id="js-hint1" class="hint hint--1">新注册员工密码默认为000000<br>请及时修改密码 <br>以免信息泄露</div>
      ...
      <form action="signup" id="js-modal" class="modal">
        ...
        <div class="modal__description">亦可赛艇小组荣誉出品</div>
        <div class="modal__section">
            <div class="input-with-label">
              <input name="ID" type="text" class="input-with-label__input">
              <label for="name" class="input-with-label__label">请输入您的员工ID

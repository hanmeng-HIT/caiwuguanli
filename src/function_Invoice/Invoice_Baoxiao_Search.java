...
public class Invoice_Baoxiao_Search extends ActionSupport{
	private String datekai;	
	...
	public String Search(){
		...
		ResultSet rs = null;
		String sql = "select * from InvoiceBaoxiao where Date_Kai='"+datekai+"'";
		try{
	...
	public String getDatekai() {
		return datekai;
	}

	public void setDatekai(String datekai) {
		this.datekai = datekai;
	}
